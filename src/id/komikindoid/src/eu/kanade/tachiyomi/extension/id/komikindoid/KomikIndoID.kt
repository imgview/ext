...
class KomikIndoID : ParsedHttpSource(), ConfigurableSource {
    ...
    // Mengakses SharedPreferences menggunakan Injekt
    private val preferences: SharedPreferences by lazy {
        Injekt.get<Application>().getSharedPreferences("source_$id", 0x0000)
    }

    // Mengambil baseUrl dari SharedPreferences atau menggunakan default
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        val baseUrlPref = EditTextPreference(screen.context).apply {
            ...
            dialogMessage = "Original: $DEFAULT_BASE_URL"
