...
class TukangKomik :
    MangaThemesia(
        "TukangKomik",
        "https://komiku.com",  // Default domain
        "en",
        "/manga",
    ...
    // Ambil domain dari preferensi
    private val domainUrl: String
        get() = preferences.getString("domain_preference", "https://komiku.com") ?: "https://komiku.com"
    ...
    override fun searchMangaRequest(page: Int, query: String, filters: FilterList): Request {
        return if (query.isEmpty()) {
            ...
            GET("$domainUrl/?s=$query&page=$page", headers) // Menggunakan domain yang diambil dari preferensi
        }
    }
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        // Tambahkan preferensi untuk mengubah domain
        val domainPreference = EditTextPreference(screen.context).apply {
            key = "domain_preference"
            title = "Domain"
            summary = "Masukkan domain yang ingin digunakan (default: https://komiku.com)"
            setDefaultValue("https://komiku.com")
        }
